...
April 19, 2026 – Individual Meeting with Michael

Had my individual meeting with Michael today and we discussed one of the questions I had been going back and forth on: whether to use multiple sensors or just one. We talked through the pros and cons, and ultimately decided that one sensor is the best approach for this project, keeping it clean and focused rather than adding unnecessary complexity.
The bigger decision we made today was about placement. We agreed that the sensor should be mounted in a frame, positioned right on top, so that it has a direct, unobstructed angle looking down at the puppet. This way, the sensor will have the best possible view of the puppet's movements, and the motor responding to it will be accurate and reliable. Having it framed on top also keeps the setup tidy and integrated into the overall aesthetic of the piece, rather than having wires or hardware sticking out awkwardly to the side.
